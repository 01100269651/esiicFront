...
@Component({
  ...
  selector: 'app-tran-income',

  templateUrl: './tran-income.component.html',

  styleUrls: ['./tran-income.component.css']
 
})

export class TranIncomeComponent {
  ...
  constructor(public dialog: MatDialog ,private scmFactSer:SCMFactService ,   private entertotab:EnterToTabService,
    ...
    private supServ:SupplierService ,private  accServ:FAccountMService ,private inServ:InSTOKService ,private _snackBar: MatSnackBar
    ) {
