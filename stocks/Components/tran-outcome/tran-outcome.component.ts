...
import { TranIncomeComponent } from '../tran-income/tran-income.component';
...
@Component({
  selector: 'app-tran-outcome',
  templateUrl: './tran-outcome.component.html',
  styleUrls: ['./tran-outcome.component.css'],  
})
export class TranOutcomeComponent {
  Fact: string = '';
